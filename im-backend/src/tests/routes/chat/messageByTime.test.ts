...
describe("POST /api/group/create", () => {
    ...
    it("should respond with \"Error Getting Message By Time. Error: ...\" when there is an error", async () => {
        ...
        expect(response.json()).toEqual({
            code: -1,
            msg: "Error Getting Message By Time. Error: Invalid refresh token",
            msgList: []
        });
    });
    ...
    it("should respond with \"Error Getting Message By Time. Error: ...\" when there is an error", async () => {
        ...
        expect(response.json()).toEqual({
            code: -1,
            msg: "Error Getting Message By Time. Error: Error Getting Message List By Time In Model. Error: The conversation doesn't exist.",
            msgList: []
        });
    });
});